...
boy = LineClient()
#boy = LineClient(authToken="EH4yimDsMzHs1QoKIcC3.bzcvQGZc9U8c2k5YW0mbyW.kXy2XKPxY6sAesCzuCemLuZ9s+ZuwtoI9gm2kY5BMPE=")
...
owner = ["uca500811d11a5346db4bcdcc63453051"]
admin = ["uca500811d11a5346db4bcdcc63453051"]
...
def siderMembers(to, mid):
    try:
        arrData = ""
        textx = "═══════════════════════                  ✍≈ᴀᴜᴛᴏ ᴄʏᴅᴜᴋ≈✍                  ═══════════════════════                ❄❄ ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
